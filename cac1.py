...
def create_correlogram(img,M,D):
    ...
    array = np.asarray(img.convert('LA'))[:,:,0]
    acc = np.zeros((M,D))
    arr = array
    num = np.zeros((M,1))
    counter = 0
...
acorrelogram1 = create_correlogram(img1,256,4)
print("1 down")
img2 = Image.open('HW-1/images/all_souls_000091.jpg')
acorrelogram2 = create_correlogram(img2,256,4)
print("2 down")
img3 = Image.open('HW-1/images/all_souls_000220.jpg')
acorrelogram3 = create_correlogram(img3,256,4)

img4 = Image.open('HW-1/images/oxford_003521.jpg')
acorrelogram4 = create_correlogram(img4,256,4)

img5 = Image.open('HW-1/images/cornmarket_000071.jpg')
acorrelogram5 = create_correlogram(img5,256,4)

img6 = Image.open('HW-1/images/hertford_000105.jpg')
acorrelogram6 = create_correlogram(img6,256,4)


# In[7]:


print(compare_cac(acorrelogram1,acorrelogram1,256,4))
print(compare_cac(acorrelogram1,acorrelogram2,256,4))
print(compare_cac(acorrelogram1,acorrelogram3,256,4))
print(compare_cac(acorrelogram1,acorrelogram4,256,4))
print(compare_cac(acorrelogram1,acorrelogram5,256,4))
print(compare_cac(acorrelogram1,acorrelogram6,256,4))
...
for imn in image_names:
    ...
    pth = 'HW-1/images/'+imn
    imgx = Image.open(pth)
    acorrelogramx = create_correlogram(imgx,256,4)
    val = compare_cac(acorrelogram1,acorrelogramx,256,4)
    if val < fmaxval:
        tmaxval  = smaxval
        smaxval = fmaxval
        fmaxval = val
